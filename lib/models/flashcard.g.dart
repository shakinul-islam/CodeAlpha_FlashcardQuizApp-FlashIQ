...
extension FlashcardQueryFilter
  ...
  QueryBuilder<Flashcard, Flashcard, QAfterFilterCondition> isFavoriteEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension FlashcardQuerySortBy on QueryBuilder<Flashcard, Flashcard, QSortBy> {
  ...
  QueryBuilder<Flashcard, Flashcard, QAfterSortBy> sortByIsFavorite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFavorite', Sort.asc);
    });
  }

  QueryBuilder<Flashcard, Flashcard, QAfterSortBy> sortByIsFavoriteDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension FlashcardQuerySortThenBy
  ...
  QueryBuilder<Flashcard, Flashcard, QAfterSortBy> thenByIsFavorite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFavorite', Sort.asc);
    });
  }

  QueryBuilder<Flashcard, Flashcard, QAfterSortBy> thenByIsFavoriteDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFavorite', Sort.desc);
    });
  }
...
extension FlashcardQueryWhereDistinct
  ...
  QueryBuilder<Flashcard, Flashcard, QDistinct> distinctByIsFavorite() {
    return QueryBuilder.apply(this, (query) {
...
extension FlashcardQueryProperty
  ...
  QueryBuilder<Flashcard, bool, QQueryOperations> isFavoriteProperty() {
    return QueryBuilder.apply(this, (query) {
